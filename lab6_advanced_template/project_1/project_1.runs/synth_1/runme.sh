...
HD_PWD='C:/logic_design/lab6_advanced_template/lab6_advanced_template/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6_advanced.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab6_advanced.tcl
