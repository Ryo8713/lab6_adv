...
HD_PWD='C:/logic_design/lab6_advanced_template/lab6_advanced_template/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6_advanced.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab6_advanced.tcl -notrace
